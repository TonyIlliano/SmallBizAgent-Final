...
export async function sendAppointmentReminder(
  ...
  try {
    ...
    const message = `Hi ${customer.firstName}! Reminder from ${business.name}: your ${serviceName} appointment is on ${dateStr} at ${timeStr}. Reply CONFIRM to confirm, or call ${contactNumber} to reschedule.\n\nReply STOP to unsubscribe.`;
